import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as t,c as l,d as n,f as s,a as o,e as c}from"./app-EyBvMEPc.js";const d={},p=n("h1",{id:"nginx",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nginx"},[n("span",null,"Nginx")])],-1),r={href:"https://www.kuangstudy.com/bbs/1377454518035292162",target:"_blank",rel:"noopener noreferrer"},u=n("p",null,"Nginx 三大作用：1）动静分离 2）反向代理 3）负载均衡",-1),v=n("p",null,[s("特点：一旦启动永远不需要重启，但是我们需要重新加载配置文件 "),n("code",null,"nginx -s reload")],-1),m=c(`<p>常用配置：Nginx 代理后会丢失很多东西，比如 host.. 也可以使用 nginx 设置每一个请求的唯一 id</p><p><strong>nginx server_name 多个的话，空格隔开就行</strong> 恰好nginx -t检查不会报错。 跟其它配置混一起，感觉有时生效，有时不生效，排查了好久。现在看来是nginx把 “a.example.com,”当成匹配规则了。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#主配置文件</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="一、反向代理" tabindex="-1"><a class="header-anchor" href="#一、反向代理"><span>一、反向代理</span></a></h1><h2 id="正向代理-vs-反向代理-的概念" tabindex="-1"><a class="header-anchor" href="#正向代理-vs-反向代理-的概念"><span>正向代理 vs 反向代理 的概念</span></a></h2><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code>    正向代理：例如翻墙软件，客户端请求到香港的一台服务器，由这台服务器再请求到美国等其它被墙地区的服务器。
    代理客户端的
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="三、动静分离" tabindex="-1"><a class="header-anchor" href="#三、动静分离"><span>三、动静分离</span></a></h1><blockquote><p>有错误不要蒙头瞎搞，瞎百度。先凝练自己的问题。 第一步是查 log 我就是靠这个分析出了错误！</p><p>问题：假如项目没用Thymeleaf 用的vue 是不是就不需要nginx处理动静分离了</p></blockquote><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>upstream gulimall { 
	server 127.0.0.1:88;
}
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,35);function b(g,k){const a=i("ExternalLinkIcon");return t(),l("div",null,[p,n("blockquote",null,[n("p",null,[n("a",r,[s("狂神Nginx学习笔记"),o(a)])]),u,v]),m])}const y=e(d,[["render",b],["__file","Nginx.html.vue"]]),_=JSON.parse('{"path":"/studynotes/408-Network/Nginx.html","title":"Nginx","lang":"zh-CN","frontmatter":{"description":"Nginx 狂神Nginx学习笔记 Nginx 三大作用：1）动静分离 2）反向代理 3）负载均衡 特点：一旦启动永远不需要重启，但是我们需要重新加载配置文件 nginx -s reload 常用配置：Nginx 代理后会丢失很多东西，比如 host.. 也可以使用 nginx 设置每一个请求的唯一 id nginx server_name 多个的话，...","head":[["meta",{"property":"og:url","content":"https://vuepress-theme-hope-docs-demo.netlify.app/zzq8/studynotes/408-Network/Nginx.html"}],["meta",{"property":"og:site_name","content":"Zz"}],["meta",{"property":"og:title","content":"Nginx"}],["meta",{"property":"og:description","content":"Nginx 狂神Nginx学习笔记 Nginx 三大作用：1）动静分离 2）反向代理 3）负载均衡 特点：一旦启动永远不需要重启，但是我们需要重新加载配置文件 nginx -s reload 常用配置：Nginx 代理后会丢失很多东西，比如 host.. 也可以使用 nginx 设置每一个请求的唯一 id nginx server_name 多个的话，..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://kuangstudy.oss-cn-beijing.aliyuncs.com/bbs/2021/01/25/kuangstudy46bdad36-d3e0-43b0-a223-43360b7e8fc7.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-04-13T08:39:03.000Z"}],["meta",{"property":"article:modified_time","content":"2024-04-13T08:39:03.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Nginx\\",\\"image\\":[\\"https://kuangstudy.oss-cn-beijing.aliyuncs.com/bbs/2021/01/25/kuangstudy46bdad36-d3e0-43b0-a223-43360b7e8fc7.png\\",\\"https://kuangstudy.oss-cn-beijing.aliyuncs.com/bbs/2021/01/25/kuangstudy62a15097-6e2a-4dbe-bcf5-f0d7cab81089.png\\"],\\"dateModified\\":\\"2024-04-13T08:39:03.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"正向代理 vs 反向代理 的概念","slug":"正向代理-vs-反向代理-的概念","link":"#正向代理-vs-反向代理-的概念","children":[]},{"level":2,"title":"5.1.root & alias","slug":"_5-1-root-alias","link":"#_5-1-root-alias","children":[]}],"git":{"createdTime":1712997543000,"updatedTime":1712997543000,"contributors":[{"name":"Fighting","email":"1024zzq@gmail.com","commits":1}]},"readingTime":{"minutes":3.96,"words":1187},"filePathRelative":"studynotes/408-Network/Nginx.md","localizedDate":"2024年4月13日","autoDesc":true,"excerpt":"\\n<blockquote>\\n<p><a href=\\"https://www.kuangstudy.com/bbs/1377454518035292162\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">狂神Nginx学习笔记</a></p>\\n<p>Nginx 三大作用：1）动静分离  2）反向代理  3）负载均衡</p>\\n<p>特点：一旦启动永远不需要重启，但是我们需要重新加载配置文件 <code>nginx -s reload</code></p>\\n</blockquote>\\n<p>常用配置：Nginx 代理后会丢失很多东西，比如 host.. 也可以使用 nginx 设置每一个请求的唯一 id</p>"}');export{y as comp,_ as data};
