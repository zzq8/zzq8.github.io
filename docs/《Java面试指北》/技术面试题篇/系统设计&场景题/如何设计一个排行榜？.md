...
![2021060714195385.png](./img/如何设计一个排行榜？/1659798897967-7ebd0b21-da39-47af-9445-fcd75b0881a1-738077.png)
...
不过，**能不能用 MySQL 的 ORDER BY 关键字还是要看具体的业务场景。如果说你的项目需要排序数据量比较小并且业务场景不复杂的话（比如你对你博客的所有文章按照阅读量来排序），我觉得直接使用 MySQL 的 **<code>**ORDER BY**</code>** 关键字就可以了。**

## Redis 的 Sorted Set

![up-d90863bb4c39ef96f9893244b9d5f1376ac.png](./img/如何设计一个排行榜？/1677744806029-54caee45-e42a-4b86-ab2b-1178cde61c1e-487313.png)
...
![image-20220719124437791.png](./img/如何设计一个排行榜？/1659944363991-9e0b5a17-56b2-46df-92f8-bac4eeaaa186-961812.png)
...
![up-c25cf4cc1d4d3a484b4db93672138b8c104.png](./img/如何设计一个排行榜？/1677744805795-83d878b9-f466-436d-a889-fa633becf0bc-993151.png)
...
![f96df332f62069398a006c631684edab.png](./img/如何设计一个排行榜？/1677744805756-5e3e579b-3fd6-48cc-8fbe-108fc4c61b78-171430.png)
...
**有哪些场景可以用到多个**<code>**sorted set**</code>\*\* 的交集呢？\*\*
