...
![image-20220124101258620.png](./img/泛型&通配符常见面试题总结/1646180073730-11b0bd1c-95ae-4ef1-9aa1-0cc1fee5962a-834056.png)
...
\*\*上边界通配符 \*\*<code>**extends**</code> 可以实现泛型的向上转型即传入的类型实参必须是指定类型的子类型。
...
\*\*下边界通配符 \*\*<code>**super**</code> 与上边界通配符 `extends`刚好相反，它可以实现泛型的向下转型即传入的类型实参必须是指定类型的父类型。
