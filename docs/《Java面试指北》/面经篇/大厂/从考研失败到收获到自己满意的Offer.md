...
* \_ConcurrentHashMap\_和\_HashMap\_的区别是什么？\_ConcurrentHashMap\_为什么线程安全？
* **HashMap 和 HashSet 的区别？HashSet 是如何检查重复的？**
* Java 中线程的状态？join()、yield()方法是干什么？
* Object 类下有哪些方法？
* 字符串"*123*"转换成整型\_123\_的\_API\_是什么？整型\_123\_转换成字符串“*123*”的 API 又是什么？
* **创建线程有几种方式？分别是怎么做的？**
